...
export const de: Dictionary = {
  common: {
    ...
    reset: 'Zurücksetzen',
    close: 'Schließen',
    preparing: 'Puzzles werden vorbereitet…',
  ...
  cloud: {
    ...
    promptSignInBody: (puzzles: number) =>
      `Du hast ${puzzles} Puzzles gelöst. Verbinde dich mit Play Games und ELO und Statistiken bleiben sicher, auch bei Handywechsel oder Neuinstallation.`,
    promptSignInBodyFresh: 'Verbinde dich mit Play Games und ELO, Verlauf und Statistiken werden von allein gesichert. Wenn du vorher auf einem anderen Gerät gespielt hast, ist dein Fortschritt sofort zurück.',
    ...
    errors: {
      auth: 'Deine Play-Games-Sitzung ist abgelaufen. Bitte verbinde dich erneut.',
      network: 'Keine Verbindung zu Play Games.',
