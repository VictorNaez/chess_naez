...
export const en: Dictionary = {
  common: {
    ...
    reset: 'Reset',
    close: 'Close',
    preparing: 'Getting the puzzles ready…',
    retry: 'Retry',
    next: 'Next',
  ...
  cloud: {
    ...
    promptSignInBody: (puzzles: number) =>
      `You have solved ${puzzles} puzzles. Connect to Play Games and your ELO and stats stay safe, even if you change phone or reinstall.`,
    promptSignInBodyFresh: 'Connect to Play Games and your ELO, history and stats are kept automatically. If you played before on another device, your progress comes back right now.',
    ...
    promptLater: 'Not now',
    errors: {
      auth: 'Your Play Games session expired. Please connect again.',
      network: 'No connection to Play Games.',
