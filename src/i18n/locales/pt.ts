...
export const pt: Dictionary = {
  common: {
    ...
    reset: 'Redefinir',
    close: 'Fechar',
    preparing: 'A preparar os puzzles…',
  ...
  cloud: {
    ...
    promptSignInBody: (puzzles: number) =>
      `Já resolveu ${puzzles} puzzles. Ligue-se ao Play Games e o seu ELO e estatísticas ficam seguros, mesmo que mude de telemóvel ou reinstale.`,
    promptSignInBodyFresh: 'Ligue-se ao Play Games e o seu ELO, histórico e estatísticas ficam guardados sozinhos. Se já jogava noutro dispositivo, recupera o seu progresso agora mesmo.',
    ...
    errors: {
      auth: 'A sua sessão Play Games expirou. Ligue-se novamente.',
      network: 'Sem ligação ao Play Games.',
