...
export const ru: Dictionary = {
  ...
  cloud: {
    section: 'КОПИЯ В ОБЛАКЕ',
    signedOut: 'Храните прогресс в своём Google Диске',
    signedOutHint: 'Рейтинг, история и статистика будут доступны на любом устройстве с тем же аккаунтом и переживут переустановку. Они хранятся в приватной папке ВАШЕГО Диска: у меня нет к ним доступа.',
    signIn: 'ВОЙТИ ЧЕРЕЗ GOOGLE',
    signOut: 'Выйти',
    autoBackup: 'Автоматическая копия',
    autoBackupHint: 'Загружает прогресс при выходе из приложения, и только если он изменился',
    backupNow: 'СОХРАНИТЬ СЕЙЧАС',
    restore: 'ВОССТАНОВИТЬ',
    noBackup: 'В этом аккаунте пока нет копии',
    ...
    restoreBody: (remote: string, local: string) =>
      `Прогресс на этом устройстве (${local}) будет заменён копией:\n${remote}\n\nОтменить это нельзя.`,
    deleteRemote: 'Удалить копию',
    deleteTitle: 'Удалить копию с Диска?',
    deleteBody: 'Копия, сохранённая на вашем Диске, будет удалена. Прогресс на этом устройстве не изменится.',
    promptSignInTitle: 'Не потеряйте свой прогресс',
    promptSignInBody: (puzzles: number) =>
      `Вы решили задач: ${puzzles}. Сохраните рейтинг и статистику на Google Диске — и вернёте их на любом устройстве, даже после смены телефона или переустановки.`,
    promptSignInBodyFresh: 'Включите автоматическое сохранение — рейтинг, история и статистика будут храниться на вашем Google Диске. Если вы уже играли на другом устройстве, прогресс вернётся прямо сейчас.',
    ...
    errors: {
      auth: 'Сессия Google истекла. Войдите снова.',
      network: 'Нет связи с Google Диском.',
      config: 'Эта сборка приложения не авторизована для работы с Google Диском.',
      playServices: 'На устройстве нет Google Play Services.',
