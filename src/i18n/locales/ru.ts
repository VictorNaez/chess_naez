...
export const ru: Dictionary = {
  ...
  feedback: {
    title: 'КОНТАКТЫ',
    subtitle: 'Напишите мне. Я читаю все письма, хотя не всегда могу ответить на каждое.',
    pickCategory: 'О ЧЁМ РЕЧЬ?',
    categories: {
      bug: 'Ошибка',
      suggestion: 'Предложение',
      puzzle: 'Неверная задача',
      translation: 'Перевод',
    },
    diagnosticsNote: 'Эти данные будут добавлены в конец письма, чтобы можно было воспроизвести проблему. Их можно удалить перед отправкой.',
    diagnosticsTitle: 'Технические данные (удалите, если не хотите их отправлять):',
    bodyIntro: 'Напишите здесь своё сообщение:',
    send: 'ОТКРЫТЬ ПОЧТУ',
    noMailApp: 'Почтовое приложение не найдено. Напишите мне:',
    close: 'ЗАКРЫТЬ',
  },
  ...
  cloud: {
    signedOutHint: 'Подключитесь, чтобы рейтинг, история и статистика пережили смену телефона или переустановку.',
    statusConnected: 'Play Games подключён',
    connectedHint: 'Прогресс сохраняется и восстанавливается сам на любом устройстве.',
    statusDisconnected: 'Прогресс не сохранён в облаке',
    connectPlayGames: 'ПОДКЛЮЧИТЬ PLAY GAMES',
    playGamesNote: 'Сессия и сохранённые данные управляются в приложении Play Games.',
    restore: 'ВОССТАНОВИТЬ',
    summary: (elo: number, puzzles: number) => `ELO ${elo} · задач: ${puzzles}`,
    promptSignInTitle: 'Не потеряйте свой прогресс',
    promptSignInBody: (puzzles: number) =>
      `Вы решили задач: ${puzzles}. Подключите Play Games — рейтинг и статистика будут в безопасности даже при смене телефона или переустановке.`,
    promptSignInBodyFresh: 'Подключите Play Games — рейтинг, история и статистика будут сохраняться сами. Если вы уже играли на другом устройстве, прогресс вернётся прямо сейчас.',
    promptRestoreTitle: 'Есть более свежая копия',
    promptRestoreBody: (remote: string) =>
      `В вашем аккаунте копия опережает это устройство:\n${remote}\n\nЗагрузить её? Прогресс на этом устройстве будет заменён.`,
    promptLater: 'Не сейчас',
    errors: {
      auth: 'Сессия Play Games истекла. Подключитесь снова.',
      network: 'Нет связи с Play Games.',
      noBackup: 'В этом аккаунте нет сохранённой копии.',
      invalid: 'Загруженная копия повреждена: ваш прогресс не тронут.',
      tooBig: 'Прогресс превысил размер, допустимый для копии Play Games.',
      unknown: 'Не удалось завершить синхронизацию.',
    },
  },
  ...
  fatal: {
    ...
    body: 'Chess Naez не смог открыть ваши данные. Обычно помогает повторная попытка.',
    retry: 'ПОВТОРИТЬ',
    resetTitle: 'Если ошибка повторяется',
    resetBody: 'Можно удалить данные прогресса. Вы потеряете рейтинг, историю и очередь повторения, но приложение снова заработает. Задачи не пострадают.',
    reset: 'Удалить прогресс',
    resetConfirm: 'Рейтинг, история и очередь повторения будут удалены. Отменить это нельзя.',
    cancel: 'Отмена',
    crashTitle: 'Что-то пошло не так',
    crashBody: 'Произошла непредвиденная ошибка. Можно попробовать снова.',
