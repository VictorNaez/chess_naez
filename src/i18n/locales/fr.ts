...
export const fr: Dictionary = {
  common: {
    ...
    reset: 'Réinitialiser',
    close: 'Fermer',
    preparing: 'Préparation des puzzles…',
    retry: 'Réessayer',
    next: 'Suivant',
  ...
  cloud: {
    ...
    promptSignInBody: (puzzles: number) =>
      `Vous avez résolu ${puzzles} puzzles. Connectez-vous à Play Games et votre ELO et vos statistiques resteront à l’abri, même en changeant de téléphone.`,
    promptSignInBodyFresh: 'Connectez-vous à Play Games et votre ELO, votre historique et vos statistiques seront conservés tout seuls. Si vous jouiez déjà sur un autre appareil, votre progression revient tout de suite.',
    ...
    errors: {
      auth: 'Votre session Play Games a expiré. Reconnectez-vous.',
      network: 'Pas de connexion à Play Games.',
